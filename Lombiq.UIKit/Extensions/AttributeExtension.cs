...
{
    /// <summary>
    /// Returns <see langword="true"/> if the given model property has <see cref="RequiredAttribute"/> on it. This is
    /// required because a value type's <see cref="ModelMetadata.IsRequired"/> default is <see langword="true"/>.
    /// </summary>
    /// <remarks>
    /// <para>
    /// For more info see
